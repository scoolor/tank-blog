...
<head>
    ...
    <link rel="icon" type="image/png" href="../public/assets/AmazeUI-2.7.2/assets/i/favicon.png">
    <link rel="apple-touch-icon-precomposed" href="../public/assets/AmazeUI-2.7.2/assets/i/app-icon72x72@2x.png">
    <meta name="apple-mobile-web-app-title" content="Amaze UI" />
    <link rel="stylesheet" href="../public/assets/AmazeUI-2.7.2/assets/css/amazeui.min.css"/>
    <link rel="stylesheet" href="../public/assets/AmazeUI-2.7.2/assets/css/admin.css">
</head>
<body>
<!--[if lte IE 9]>
    ...
    <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
        <div class="am-offcanvas-bar admin-offcanvas-bar">
            <ul class="am-list admin-sidebar-list">
                <li><a href="../public/assets/AmazeUI-2.7.2/admin-index.html"><span class="am-icon-home"></span> 首页</a></li>
                <li class="admin-parent">
                    <a class="am-cf" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-file"></span> 页面模块 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
                    <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                        <li><a href="../public/assets/AmazeUI-2.7.2/admin-user.html" class="am-cf"><span class="am-icon-check"></span> 个人资料<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
                        <li><a href="../public/assets/AmazeUI-2.7.2/admin-help.html"><span class="am-icon-puzzle-piece"></span> 帮助页</a></li>
                        <li><a href="../public/assets/AmazeUI-2.7.2/admin-gallery.html"><span class="am-icon-th"></span> 相册页面<span class="am-badge am-badge-secondary am-margin-right am-fr">24</span></a></li>
                        <li><a href="../public/assets/AmazeUI-2.7.2/admin-log.html"><span class="am-icon-calendar"></span> 系统日志</a></li>
                        <li><a href="../public/assets/AmazeUI-2.7.2/admin-404.html"><span class="am-icon-bug"></span> 404</a></li>
                    </ul>
                </li>
                <li><a href="../public/assets/AmazeUI-2.7.2/admin-table.html"><span class="am-icon-table"></span> 表格</a></li>
                <li><a href="../public/assets/AmazeUI-2.7.2/admin-form.html"><span class="am-icon-pencil-square-o"></span> 表单</a></li>
                    ...
                    <div class="am-panel am-panel-default">
                        ...
                        <div id="collapse-panel-2" class="am-in">
                            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
                                ...
                                <tr>
                                    <td class="am-text-center"><img src="../public/assets/AmazeUI-2.7.2/assets/i/examples/admin-chrome.png" alt=""></td>
                                    <td>Google Chrome</td>
                                    <td>3,005</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img src="../public/assets/AmazeUI-2.7.2/assets/i/examples/admin-firefox.png" alt=""></td>
                                    <td>Mozilla Firefox</td>
                                    <td>2,505</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img src="../public/assets/AmazeUI-2.7.2/assets/i/examples/admin-ie.png" alt=""></td>
                                    <td>Internet Explorer</td>
                                    <td>1,405</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img src="../public/assets/AmazeUI-2.7.2/assets/i/examples/admin-opera.png" alt=""></td>
                                    <td>Opera</td>
                                    <td>4,005</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img src="../public/assets/AmazeUI-2.7.2/assets/i/examples/admin-safari.png" alt=""></td>
                                    <td>Safari</td>
                                    <td>505</td>
                                </tr>
                                </tbody>
...
<script src="../public/assets/AmazeUI-2.7.2/assets/js/amazeui.ie8polyfill.min.js"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="../public/assets/js/jquery.min.js"></script>
<!--<![endif]-->
<script src="../public/assets/AmazeUI-2.7.2/assets/js/amazeui.min.js"></script>
<script src="../public/assets/AmazeUI-2.7.2/assets/js/app.js"></script>
</body>
</html>
